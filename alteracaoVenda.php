    ...
    <?php } if($tipoUsuario==1){?>
      ...
      <div id="page-content-wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
          ...
          <div class="col">
          <a href="periodoVendas.php"><button type="button" class="btn btn-outline-secondary">Consultar vendas de outros períodos</button></a>
        </div>
        </nav>
        ...
        <div class="container-fluid">
          ...
          <table id="tabela" class="table table-hover">
            ...
            $timestamp=time();
            $data= date("Y-m-d");
            $consulta="Select * from tb_vendas where data_venda='$data' order by data_venda desc";
                ...
                <tr>
                  ...
                  <?php while($dado2=mysqli_fetch_array($linhas2)){ ?>
                    ...
                    <?php while($dado3=mysqli_fetch_array($linhas3)){
                      ...
                      <td>
                        <p><a href="alteracaoVenda.php?excluir=<?php echo $dado['id_venda']; ?>" data-confirm='Tem certeza que deseja excluir?'><button class="btn btn-outline-danger" >Excluir</button></a>
                          <?php
                          if($dado['status_venda']==0){
                            ?>
                          </p><p>
                            <a href="alteracaoVenda.php?pago=<?php echo $dado['id_venda']; ?>" ><button type="button" class="btn btn-outline-info">Pago</button></a>
                            <?php
                          }
                          ?>
                        </p>
            ...
            //     link.setAttribute("href", "alteracaoVenda.php?excluir="+$valor);
            //   }
            //   else
            //   {
