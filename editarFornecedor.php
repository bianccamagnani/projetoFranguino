...
<form action="function.php" method="post">
  <?php
  $result_fornecedor = "SELECT * FROM `tb_fornecedores` where id_fornecedores=".$id_fornecedor;
  $resultado_fornecedor = mysqli_query($conexao, $result_fornecedor);
  $lista = mysqli_fetch_array($resultado_fornecedor);
  $endereco=$lista['endereco_empresa'];
  ...
  $nomeEmpresa=$lista['nome_empresa'];
  $cnpjEmpresa=$lista['cnpj_empresa'];
  $telefoneEmpresa=$lista['telefone_empresa'];
  $contatoEmpresa=$lista['contato_empresa'];
  $obsEmpresa=$lista['observacao_empresa'];
  ?>
  <br><br>
  <input class="form-control" type="hidden" value="<?php echo $id_fornecedor;?>" name="id_fornecedor">
    <div class="form-group">
  <div class="form-row">
    <div class="form-group col-md-4">
  <label for="nomeCliente"> Nome da empresa: </label>
  <input class="form-control" type="text" value="<?php echo $nomeEmpresa;?>" id="nomefornecedor" name="nomefornecedor">
</div>
<div class="form-group col-md-4">
  <label>CNPJ do fornecedor:</label>
    <input class="form-control" type="text" id="cnpjfornecedor" value="<?php echo $cnpjEmpresa; ?>" name="cnpjfornecedor">
</div>
<div class="form-group col-md-4">
    <label for="telCliente">Telefone do fornecedor:</label>
    <input class="form-control" type="text" value="<?php echo $telefoneEmpresa;?>" id="telfornecedor"  name="telfornecedor">
</div>
</div>
  ...
  <label>CEP:
        <input class="form-control" name="cep" type="text" id="cep" value="<?php echo $cep;?>" /></label>
      </div>
...
<div class="form-group col-md-2">
        <label>Nº:
          <input class="form-control" name="numero" value="<?php echo $numero;?>" type="text" id="numero"  /></label>
</div>
</div>
<div class="form-row">
  <div class="form-group col-md-7">
...
<div class="form-row">
  <div class="form-group col-mb-10">
        <label>Contato do fornecedor:</label>
        <textarea class="form-control" id="contatofornecedor" name="contatofornecedor"><?php echo $contatoEmpresa;?></textarea>
</div>
<div class="form-group col-mb-9">
        <label>Observação: </label>
        <textarea  class="form-control" id="obsFornecedor" name="obsFornecedor"><?php echo $obsEmpresa;?></textarea>
</div>
</div>
</div>

<div class="form group col-md-6">
  <input class="btn btn-outline-success" type="submit" name="enviar" value="Alterar fornecedor">
</div>
</form>
</div>
</body>
...
<script type="text/javascript">
  $("#telfornecedor").mask("(00) 00000-0000");
  $("#cep").mask("00000-000");
