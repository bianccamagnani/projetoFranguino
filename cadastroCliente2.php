    ...
    <?php } if($tipoUsuario==1){?>
      ...
      <div id="page-content-wrapper">
        ...
        <div class="container-fluid justify-content-center col-6">
          <?php
          if(isset($_COOKIE['msgCliente'])){
            echo $_COOKIE['msgCliente'];
          }?>
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                ...
                <label> Endereço do cliente</label>
                  ...
                  <label>CEP:
                    <input class="form-control" name="cep" placeholder="00000-00" type="text" id="cep" value="" size="10" maxlength="9"  onkeyup="cep(this, event)" /></label>
                  </div>
                  <div class="form-group col-md-6">
                    <label>Rua:
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-5">
                          ...
                          <div class="form-group col-md-3">
                            ...
                            <div class="form-row">
                              ...
                              <label>CPF do cliente:
                                <input class="form-control cpf-mask" placeholder="000.000.000-00" type="text" id="cpfCliente" name="cpfCliente">
                              </div>
                              <div class="form-group col-md-6">
                                <label>E-mail do cliente:
                                  <input  class="form-control" type="email" id="emailCliente" name="emailCliente">
                            </div>
                          </div>
                                </div>
                                <div class="form row">
                                  <div class="form-group  col-md-6">
                                    <input type="submit"  class="btn btn-outline-success" value="Registrar cliente" name="enviar">
                                  </div>
                                  <div class="form-group  col-md-6">
                          ...
                          <script src="vendor/jquery-mask"></script>
