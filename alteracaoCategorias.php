...
<head>
  <meta charset="UTF-8">
    <title>Alteração Categoria Estoque</title>
...
<form action="functionCategorias.php" method="post">
  <?php
  $result_cliente = "select * FROM `categoriaestoque` where id_CategoriaEstoque=".$id_categoria;
  $resultado_cliente = mysqli_query($conexao, $result_cliente);
  $lista = mysqli_fetch_array($resultado_cliente);
  $descricao=$lista['nomeCategoriaEstoque'];?>
  <br><br>
